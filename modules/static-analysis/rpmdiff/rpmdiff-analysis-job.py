...
JOB_NAME = 'ci-rpmdiff-analysis'
JJB_YAML = 'ci-rpmdiff-analysis.yaml'

REQUIRED_CMDS = ['jenkins-jobs']


class CIRpmdiffAnalysisJob(Module):
    """
CI RPMdiff analysis job module

This module provides a Jenkins job for RPMdiff analysis testing. It is able to
...
file 'ci-rpmdiff-analysis.yaml' provided in the module's data directory.

Important note:
This module requires an available Jenkins connection - via the jenkins module.
"""

    name = 'rpmdiff-analysis-job'
    description = 'Create and run RPMdiff analysis job'
