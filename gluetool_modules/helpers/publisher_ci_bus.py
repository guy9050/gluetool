...
class CIBusPublisher(gluetool.Module):
    """
    ...
    def _session(self):
        ...
        try:
            ...
            raise GlueError('could not connect to CI message bus')
    ...
    def publish_bus_messages(self, messages, **kwargs):
        ...
        :raises gluetool.glue.GlueError: When there are messages that module failed to send.
        """
        ...
        for message in messages:
            ...
            body = gluetool.log.format_dict(message.body)
