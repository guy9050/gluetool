...
import libci
import libci.modules.testing.beah_result_parser
...
def fixture_module():
    ...
    return create_module(libci.modules.testing.beah_result_parser.BeahResultParser)
...
def test_loadable(module):
    ...
    python_mod = ci._load_python_module('testing', 'pytest_beah_result_parser',
                                        'libci/modules/testing/beah_result_parser.py')
