...
import libci
from libci.log import log_xml, ContextAdapter
...
class Restraint(libci.Module):
    ...
    def sanity(self):
        libci.utils.check_for_commands(['restraint'])
    ...
    def restraint(self, guest, job, port=DEFAULT_RESTRAINT_PORT):
        ...
        with tempfile.NamedTemporaryFile() as f:
            ...
            try:
                return libci.utils.run_command(restraint_command + [
